...
IMAGE_PATTERN = re.compile(r'images/[^\s"\)]+/output\.jpg')
...
LOCALES = {
    "de": {
        ...
        "intro_title": "Willkommen im Repository gpt2-images-showcase! 🤗",
        ...
        "intro_try": "Teste es auf DuctTape3: [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "Wenn dir das nuetzt, gib dem Repository gern einen Star. ⭐",
        "note_1": "> Dieses Repository konzentriert sich auf wiederverwendbare Prompt-Muster, Referenzfaelle und aufgabenspezifische Beispiele fuer GPT-Image-2 auf DuctTape3.",
        ...
        "ack_more": "Wenn du weitere interessante GPT-Image-2-Prompt-Faelle teilen moechtest, melde dich gern und hilf uns, die DuctTape3-Prompt-Bibliothek auszubauen.",
    },
    "es": {
        "path": ROOT / "README_es.md",
        "logo_alt": "Logotipo del proyecto",
        "intro_heading": "Introduccion",
        "intro_title": "Bienvenido al repositorio gpt2-images-showcase! 🤗",
        ...
        "intro_try": "Pruebalo en DuctTape3: [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "Si esto te resulta util, considera darle una estrella. ⭐",
        "note_1": "> Este repositorio se centra en patrones de prompts reutilizables, casos de referencia y ejemplos especificos por tarea para GPT-Image-2 en DuctTape3.",
        ...
        "ack_more": "Si tienes mas casos interesantes de prompts de GPT-Image-2 para compartir, no dudes en escribirnos y ayudarnos a ampliar la biblioteca de prompts de DuctTape3.",
    },
    "fr": {
        "path": ROOT / "README_fr.md",
        "logo_alt": "Logo du projet",
        "intro_heading": "Introduction",
        "intro_title": "Bienvenue dans le depot gpt2-images-showcase ! 🤗",
        ...
        "intro_try": "Essayez-le sur DuctTape3 : [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "Si cela vous est utile, pensez a mettre une etoile. ⭐",
        "note_1": "> Ce depot se concentre sur des modeles de prompts reutilisables, des cas de reference et des exemples par tache pour GPT-Image-2 sur DuctTape3.",
        ...
        "ack_more": "Explore more AI image workflows, prompt inspiration, and practical guides at [ducttape3.org](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase).",
    },
    "ja": {
        "path": ROOT / "README_ja.md",
        "logo_alt": "プロジェクトロゴ",
        "intro_heading": "紹介",
        "intro_title": "gpt2-images-showcase リポジトリへようこそ！🤗",
        ...
        "intro_try": "DuctTape3 で試す: [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "役に立ったら Star をお願いします。⭐",
        "note_1": "> このリポジトリは、DuctTape3 上の GPT-Image-2 向けに、再利用しやすいプロンプトパターン、参照事例、タスク別サンプルをまとめています。",
        ...
        "ack_more": "共有したい GPT-Image-2 の面白いプロンプト事例があれば、ぜひご連絡ください。DuctTape3 のプロンプトライブラリ拡充にご協力ください。",
    },
    "ko": {
        "path": ROOT / "README_ko.md",
        "logo_alt": "프로젝트 로고",
        "intro_heading": "소개",
        "intro_title": "gpt2-images-showcase 저장소에 오신 것을 환영합니다! 🤗",
        ...
        "intro_try": "DuctTape3에서 사용해 보기: [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "유용했다면 Star를 부탁드립니다. ⭐",
        "note_1": "> 이 저장소는 DuctTape3의 GPT-Image-2를 위한 재사용 가능한 프롬프트 패턴, 참고 사례, 작업별 예시에 초점을 맞춥니다.",
        ...
        "ack_more": "더 흥미로운 GPT-Image-2 프롬프트 사례가 있다면 언제든 공유해 주세요. DuctTape3 프롬프트 라이브러리 확장에 도움을 부탁드립니다.",
    },
    "pt": {
        "path": ROOT / "README_pt.md",
        "logo_alt": "Logotipo do projeto",
        "intro_heading": "Introducao",
        "intro_title": "Bem-vindo ao repositorio gpt2-images-showcase! 🤗",
        ...
        "intro_try": "Experimente no DuctTape3: [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "Se isso for util, considere dar uma estrela. ⭐",
        "note_1": "> Este repositorio se concentra em padroes de prompts reutilizaveis, casos de referencia e exemplos especificos por tarefa para GPT-Image-2 no DuctTape3.",
        ...
        "ack_more": "Se voce tiver mais casos interessantes de prompts de GPT-Image-2 para compartilhar, fique a vontade para falar conosco e ajudar a expandir a biblioteca de prompts da DuctTape3.",
    },
    "ru": {
        "path": ROOT / "README_ru.md",
        "logo_alt": "Логотип проекта",
        "intro_heading": "Введение",
        "intro_title": "Добро пожаловать в репозиторий gpt2-images-showcase! 🤗",
        ...
        "intro_try": "Попробовать в DuctTape3: [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "Если это полезно, поставьте звезду. ⭐",
        "note_1": "> Этот репозиторий посвящен переиспользуемым шаблонам промптов, референсным кейсам и примерам задач для GPT-Image-2 в DuctTape3.",
        ...
        "ack_more": "Если у вас есть другие интересные кейсы с промптами GPT-Image-2, поделитесь ими с нами и помогите расширить библиотеку промптов DuctTape3.",
    },
    "tr": {
        "path": ROOT / "README_tr.md",
        "logo_alt": "Proje logosu",
        "intro_heading": "Giris",
        "intro_title": "gpt2-images-showcase deposuna hos geldiniz! 🤗",
        ...
        "intro_try": "DuctTape3 uzerinde deneyin: [GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "Faydali bulduysaniz bir yildiz vermeyi dusunun. ⭐",
        "note_1": "> Bu depo, DuctTape3 uzerindeki GPT-Image-2 icin yeniden kullanilabilir prompt kaliplari, referans vakalar ve goreve ozel orneklere odaklanir.",
    ...
    "zh-CN": {
        ...
        "logo_alt": "项目 Logo",
        "intro_heading": "简介",
        "intro_title": "欢迎来到 gpt2-images-showcase 仓库！🤗",
        "intro_body": "**我们收录了 GPT-Image-2 在人像、海报、角色设计、UI 原型及社区实验等场景下的高质量提示词与图像案例。**",
        "intro_source": "仓库中的大多数案例来源于 X/Twitter 上的创作者社区、公开演示及分享实验。",
        "intro_try": "在 DuctTape3 上体验：[GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "如果觉得有用，欢迎点个 Star。⭐",
        "note_1": "> 本仓库专注于 GPT-Image-2 在 DuctTape3 上的可复用提示词模板、参考案例与任务专项示例。",
        ...
        "ack_more": "更多 AI 图像工作流、提示词灵感与实用指南，请访问 [ducttape3.org](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)。",
    },
    "zh-TW": {
        "path": ROOT / "README_zh-TW.md",
        "logo_alt": "專案 Logo",
        "intro_heading": "簡介",
        "intro_title": "歡迎來到 gpt2-images-showcase 倉庫！🤗",
        ...
        "intro_try": "在 DuctTape3 上體驗：[GPT-Image-2](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)",
        "intro_star": "如果你覺得這個倉庫有幫助，歡迎給個 Star。⭐",
        "note_1": "> 本倉庫專注於 GPT-Image-2 在 DuctTape3 上的可重用提示詞模式、參考案例與任務型示例。",
        ...
        "ack_more": "更多 AI 圖像工作流、提示詞靈感與實用指南，請造訪 [ducttape3.org](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)。",
    },
}
...
def replace_section(text: str, start_heading: str, end_heading: str, new_block: str) -> str:
    start = text.index(start_heading)
    end = text.index(end_heading, start)
    return text[:start] + new_block + text[end:]


def reorder_image_references(text: str) -> str:
    matches = IMAGE_PATTERN.findall(text)
    unique_matches = list(dict.fromkeys(matches))
    if len(unique_matches) < 3:
        return text

    pivot = len(unique_matches) // 3 or 1
    rotated = unique_matches[pivot:] + unique_matches[:pivot]
    replacement_map = dict(zip(unique_matches, rotated))
    return IMAGE_PATTERN.sub(lambda match: replacement_map.get(match.group(0), match.group(0)), text)


def build_locale(base: str, cfg: dict) -> str:
    text = base
    if 'alt="Project logo"' in text:
        text = replace_once(text, 'alt="Project logo"', f'alt="{cfg["logo_alt"]}"')
    else:
        text = replace_once(text, 'alt="DuctTape3 AI image prompt showcase"', f'alt="{cfg["logo_alt"]}"')

    text = replace_once(text, "## Introduction", f"## {cfg['intro_heading']}")
    text = replace_once(text, "Welcome to the DuctTape3 GPT-Image-2 showcase.", cfg["intro_title"])
    text = replace_once(text, "**This repository is a hand-picked reference board of GPT-Image-2 prompts, outputs, and visual recipes assembled for DuctTape3 users building faster creative workflows.**", cfg["intro_body"])
    text = replace_once(text, "The examples below span portraits, posters, character concepts, interface mockups, and remixable ideas collected from public creator experiments.", cfg["intro_source"])
    text = replace_once(text, "Discover more workflow notes on DuctTape3: [ducttape3.org](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase)", cfg["intro_try"])
    text = replace_once(text, "If this gallery saves you time, feel free to star the repo.", cfg["intro_star"])
    text = replace_once(text, "> We maintain this repository as a working gallery of prompt structures, image outcomes, and reusable composition ideas for GPT-Image-2.", cfg["note_1"])
    text = replace_once(text, "> For more AI workflow write-ups, tool collections, and prompt experiments, visit [ducttape3.org](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase).", cfg["note_2"])

    news_block = f"## {cfg['news_heading']}\n\n" + "\n".join(cfg["news"]) + "\n\n"
    text = replace_section(text, "## News", "## 📑 Menu", news_block)
    ...
    text = replace_once(text, "This showcase was assembled from publicly shared GPT-Image-2 explorations, creator threads, and open prompt references.", cfg["ack_intro"])
    text = replace_once(text, "Thanks to everyone who published examples, prompts, and outputs that made this gallery possible.", cfg["ack_thanks"])
    text = replace_once(text, "*Attribution may still be incomplete in a few places. If you spot something that should be credited or corrected, contact us and we will update it.*", cfg["ack_note"])
    text = replace_once(text, "Explore more AI image workflow notes, prompt references, and tool guides at [ducttape3.org](https://ducttape3.org/?utm_source=github&utm_medium=readme&utm_campaign=gpt2_images_showcase).", cfg["ack_more"])
    return reorder_image_references(text)
